...
object GlobalVariableDeclaration {
    ...
    def COUNT(PQL: PQL): DataCell = DataCell(PQL.dh.COUNT_OF_LAST_QUERY, DataType.INTEGER)
    def TOTAL(PQL: PQL): DataCell = DataCell(PQL.dh.TOTAL_COUNT_OF_RECENT_QUERY, DataType.INTEGER)
    def COUNT_OF_LAST_QUERY(PQL: PQL): DataCell = DataCell(PQL.COUNT_OF_LAST_QUERY, DataType.INTEGER)
    def TOTAL_COUNT_OF_RECENT_QUERY(PQL: PQL): DataCell = DataCell(PQL.dh.TOTAL_COUNT_OF_RECENT_QUERY, DataType.INTEGER)
