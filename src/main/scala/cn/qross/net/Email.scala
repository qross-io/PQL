...
import cn.qross.exception.{EmailInvalidSenderException, ExtensionNotFoundException}
...
import cn.qross.setting.{Global, Language}
...
class Email(private var title: String) {
    ...
    def useTemplate(template: String): Email = {
        ...
        //cn.qross.pql.PQL.runEmbeddedFile(args.head.asText).toString
